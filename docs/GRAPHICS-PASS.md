...
Twenty-one materials live in `/Game/Art/Materials`. They distinguish gray-brown fur and a lighter chest; deep purple woven jacket cloth; skin, glossy eyes, claws, whiskers and brass; weathered timber, mineral stone, plaster, slate, iron, water and sky. The initial nineteen-material pass used original procedural color and normal variation. Stone and timber now use the sourced scans described below; Canvas and Leather extend the original procedural set for the worker. Fine cloth/fur detail is filtered at distance. Character patterns use interpolated undeformed positions so they follow the rig. World surfaces use centimetre-scaled world coordinates.
...
## Contact and reflection study

The DirectX 11 renderer now enables screen-space reflections at quality 50 and intensity 75. Ambient occlusion uses a 35 cm world-space radius and intensity 0.65; the sun adds 8 cm contact shadows. These settings target grounding around small feet and props. Reflections are limited to visible screen information, so off-screen geometry and screen edges remain limitations. No Lumen, ray tracing, exposure adaptation, motion blur, engine upgrade or new dependency was added. Water remains opaque and has no physical shoreline simulation. Sustained frame-time profiling remains outstanding.
