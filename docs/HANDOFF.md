...
Setup verification: full reference copies matched source SHA-256 hashes; generated project/plugin paths and packaged output match Git exclusions; .uasset, .umap and .blend resolve to LFS. Local LFS hooks initialized, no binary assets or remote present. Source whitespace is intentionally preserved in reference snapshots.
