...
Chuck is a 65 cm gray rat with an oversized purple open jacket. His capsule is 65 cm tall and 30 cm wide; the human is 180 cm tall and tavern door 210 cm tall. Speed-matched footsteps, slight body lean, airborne foot tuck and landing compression affect visual components only. A Blender skeletal rig now articulates the legs, sleeves and four-bone tail. Procedural two-bone leg IK follows the foot targets; authored animation clips and terrain-aware foot planting remain future work. Use real scale rather than shrinking a human template visually.
